...
class SimilarResponses {
  ...
  SimilarResponses.fromJson(dynamic json) {
    ...
    if (json['results'] != null) {
      ...
      json['results'].forEach((v) {
        _results?.add(SimilarMovies.fromJson(v));
      });
    }
  ...
  num? _page;
  List<SimilarMovies>? _results;
  num? _totalPages;
  num? _totalResults;
SimilarResponses copyWith({  num? page,
  List<SimilarMovies>? results,
  num? totalPages,
  num? totalResults,
}) => SimilarResponses(  page: page ?? _page,
  results: results ?? _results,
  totalPages: totalPages ?? _totalPages,
  totalResults: totalResults ?? _totalResults,
);
  num? get page => _page;
  List<SimilarMovies>? get results => _results;
  num? get totalPages => _totalPages;
  num? get totalResults => _totalResults;
}

class SimilarMovies extends Movie{
  SimilarMovies({
      bool? adult, 
      String? backdropPath, 
      List<num>? genreIds, 
  ...
  num? _voteAverage;
  num? _voteCount;
SimilarMovies copyWith({  bool? adult,
  String? backdropPath,
  List<num>? genreIds,
  num? id,
  String? originalLanguage,
  ...
  num? voteAverage,
  num? voteCount,
}) => SimilarMovies(  adult: adult ?? _adult,
