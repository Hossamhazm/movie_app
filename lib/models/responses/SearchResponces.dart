class SearchResponces {
  ...
  SearchResponces.fromJson(dynamic json) {
    _page = json['page'];
  ...
  num? _totalPages;
  num? _totalResults;
SearchResponces copyWith({  num? page,
  List<SearchResults>? results,
  num? totalPages,
  num? totalResults,
}) => SearchResponces(  page: page ?? _page,
...
SearchResults copyWith({  bool? adult,
  ...
  num? voteAverage,
  num? voteCount,
}) => SearchResults(  adult: adult ?? _adult,
